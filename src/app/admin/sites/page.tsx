    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Link href="/admin/sites/new" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                    + Create New Site
                </Link>
            </div>
                        ...
                        {sites.map((site) => (
                            <tr key={site.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <Link href={`/admin/sites/${site.id}`} className="text-blue-600 hover:text-blue-900 mr-4">
                                        Edit
                                    </Link>
                                </td>
                            </tr>
